    ...
    <div class="day-event" :style="getEventBackgroundColor">
        <div v-if="!event.edit">
            ...
            <div class="has-text-centered icons">
                <i class="fa fa-pencil-square edit-icon" @click="editEvent(day.id, event.details)"/>
                <i class="fa fa-trash-o delete-icon" @click="deleteEvent(day.id, event.details)"/>
            </div>
        </div>
        <div v-if="event.edit">
            <label>
    ...
    export default {
        ...
        methods: {
            ...
            updateEvent(dayId, originalEventDetails, updatedEventDetails) {
                if (updatedEventDetails === '' || updatedEventDetails.trim() === '') {
