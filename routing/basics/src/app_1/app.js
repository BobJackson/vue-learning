...
const TheDarkKnightRisesDunkirkBlurb = {
...
const routes = [
    {
        ...
        component:{
            name: 'index-blurb',
            template: `<h2>Pick a Christopher Nolan Movies</h2>`
        }
    },
    {path: '/drunkirk',component: DunkirkBlurb},
    {path: '/interstellar',component: InterstellarBlurb},
    {path: '/the-dark-knight-rises',component: TheDarkKnightRisesDunkirkBlurb},
];
